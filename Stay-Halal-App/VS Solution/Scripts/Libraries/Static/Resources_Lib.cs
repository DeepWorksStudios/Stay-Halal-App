...
public static class Resources_Lib
{
    ...
    #endregion
    #region FAQ
    public static QAModel Qestion_1a = new QAModel() { QestionTitle = "Kann ich die App nur in Deutschland nutzen?", QestionDescription = "Ja, der Standort des Nutzers spielt überhaupt keine Rolle ...", AwnserTitle = "Kann ich die App nur in Deutschland nutzen?", AwnserDescription = "Sie können unabhängig ihres Standortes von unserer App profitieren, und jederzeit Produkte mit unserer App nach islamischen Prinzipien überprüfen lassen. Der Standort spielt dabei überhaupt keine Rolle." };
    public static QAModel Qestion_1b = new QAModel() { QestionTitle = "Funktioniert die App auch ohne Internetverbindung?", QestionDescription = "Ja, die App kann auch ohne Interverbindung genutzt werden, aber ...", AwnserTitle = "Funktioniert die App auch ohne Internetverbindung?", AwnserDescription = "Ja, die App kann auch ohne eine aktive Interverbindung genutzt werden, wenn Sie in den Einstellungen 'Data - Caching' aktiviert haben und die App einmalig mit einer aktiven Internetverbindung geladen haben. Hierbei werden jegliche Produkt für weitere Nutzungen lokal auf ihr Endgerät gespeichert, sodass keine aktive Internetverbindung mehr von Nöten ist, jedoch ist eine ständige Internetverbindung empfohlen wenn Sie auf dem aktuellsten Stand unserer Lebensmitteldatenbank sein möchten." };
    ...
    public static QAModel Qestion_1d = new QAModel() { QestionTitle = "Wo finde ich weitere Infos zu Halal-Lebensmitteln?", QestionDescription = "Es gibt viele Quelle, doch wir ...", AwnserTitle = "Wo finde ich weitere Infos zu Halal-Lebensmitteln?", AwnserDescription = "Wir beziehen unsere Information aus einem zertifizierten Institut, welches sich mit dem Thema Halal beschäftigt. Dort finden Sie weitere Informationen rund um das Thema Halal: https://halalpi.com/" };
    #endregion
    #endregion
    #region Navigation
    #region Flyout
